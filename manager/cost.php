...
<body>
	...
	<div class="container">
		...
		<div class="child2"><br>
			<h4 style="margin-left:20%;text-align: center;color:#99955f;height:60px;background:white;width:40%;" >Daily Bazar Cost</h4><br>	
		...
		<?php   }
			...
			{ 
				$query=mysqli_query($conn,"select * from bazarcost");
				$result=mysqli_fetch_array($query);
				...
				if($result<=0)
				{
					...
					while($id<32){
						...
						$query="insert into bazarcost(id,date,amount) values('$id','$date',0)";
