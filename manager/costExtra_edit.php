...
<?php 
    if(isset($_POST['submit'])){
        ...
        $query="insert into extracost(date,description,amount) values('$date','$description','$cost') ";
		...
		if($result)
		{
			...
			<strong>Extra Cost Added Successfully!</strong>
			</div>"; 
...
<body>
	...
	<div class="container">
		...
		<div class="basic"  >
			<h3 style="text-align:center;padding: 13px;">Add Today's Extra Cost</h3>
		</div>
		...
		<div class="addform">
			  ...
			  <h3>Today Date:&nbsp<?php echo date('d/m/y');?></h3><br>
			   ...
			   <form class="formmain" method="post" enctype="multipart/form-data">
						...
						<input type="text" name="description" required="" placeholder="Enter goods name"><br><br>
						
						<label>Amount :&nbsp</label>
						<input type="number" step="any" name="cost" required="" placeholder="Enter Today's Extra Cost"><br><br>
						
						<label>Date :&nbsp</label>
						<input type="date"  name="date" required="" placeholder="Enter Date"><br><br>
