...
<?php 
    if(isset($_POST['submit'])){
        ...
        $query="UPDATE bazarcost set amount='$cost' WHERE date='$date' ";
		...
		if($result)
		{
			...
			<strong>Today's Bazar Cost Added Successfully!</strong>
			</div>"; 
...
<body>
	...
	<div class="container">
		...
		<div class="basic"  >
			<h3 style="text-align:center;padding: 13px;">Add Today's Bazar Cost</h3>
		</div>
		...
		<div class="addform">
			  ...
			  <h3>Today Date:&nbsp<?php echo date('d/m/y');?></h3><br>
			   ...
			   <form class="formmain" method="post" enctype="multipart/form-data">
					    ...
					    <label>Bazar Date:&nbsp <span style="color:red">*</span> </label> <?php echo $_GET['date'] ;?><br><br>
						
						<label>Amount :&nbsp</label>
						<input type="number" step="any" name="cost" required="" placeholder="Enter Today's Bazar Cost!"><br>
