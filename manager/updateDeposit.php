...
<?php 
    if(isset($_POST['submit'])){
        ...
        $query="UPDATE deposit set amount ='$amount',date='$date' WHERE phone='$phone' ";
		...
		if($result)
		{
			...
			<strong>Deposit Add Successfully!</strong>
			</div>"; 
...
<body>
	...
	<div class="container">
		...
		<div class="basic"  >
			<h3 style="text-align:center;padding: 13px;">Add Money</h3>
		</div>
		...
		<div class="addform">
			  ...
			  <h3>Today Date:&nbsp<?php echo date('d/m/y');?></h3><br>
			   ...
			   <form class="formmain" method="post" enctype="multipart/form-data">
					    ...
					    <label>Name  :&nbsp <span style="color:red">*</span> </label> <?php echo $_GET['name'] ;?><br>
						<label>Phone :&nbsp <span style="color:red">*</span> </label><?php echo $_GET['update'];?><br><br>
						
						<label>Enter New Amount:&nbsp</label>
						<input type="number" step="any" name="amount" required="" placeholder="  <?php echo $_GET['amnt']; ?> BDT "><br>
