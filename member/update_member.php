...
<body>
	...
	<div class="container">
		<div class="child">
			...
			<p class="child2" >Member Information</p>
		</div>
					  ...
					  <?php
							...
							if($num > 0){ 
								while ($rows = $rs->fetch_assoc()) {
									$sn = $sn + 1;
									$userID=$_SESSION['phone_no'];
									if($userID==$rows['phone']){
										
										echo"
											<tr style='background-color:#96f794'>
												<td>".$sn."</td>
												<td>".$rows['name']."</td>
												<td>".$rows['email']."</td>
												<td>".$rows['password']."</td>
												...
												<td>".$rows['address']."</td>
												<td class='edit'>".$rows['Joining_Date']."&nbsp &nbsp &nbsp
	<a  href='member_edit.php?edit=".$rows['email']."'><i class='fa fa-edit cntr link1'  style=\"color:#0509f0;font-size:20px;\"></i></a>
												</td>
										...
										echo"
											<tr>
												...
												<td style='text-align:center;' >".$rows['room_no']."</td>
												<td>".$rows['address']."</td>
												<td class='edit'>".$rows['Joining_Date']."</td>
											</tr>";
									}
								}
							}
